        ...
        <div className="container relative z-10 px-4 py-16 lg:py-24 grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7 space-y-7">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-bold text-foreground leading-[1.1]">
              ...
              <br />{t("home.hero.title_part3", "— from your living room.")}
            </h1>

            <p className="text-lg text-muted-foreground max-w-xl leading-relaxed">
              {t("home.hero.subtitle", "Live Arabic & Urdu classes for sisters, taught by qualified female teachers. Flexible timings, no judgment, your camera on a safe space.")}
            </p>
            ...
            <div className="flex items-center gap-6 pt-6 border-t border-border/50">
              ...
              <div className="text-sm">
                <p className="font-bold text-foreground">
                  {stats?.totalStudents || 500}+ {t("home.hero.sisters_learning", "sisters learning")}
                </p>
                <p className="text-muted-foreground">
                  {t("home.hero.across", "across")} {stats?.countriesReached || 12}+ {t("home.hero.countries", "countries")}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container px-4">
          <div className="flex flex-wrap justify-center gap-6 md:gap-12 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium">{t("home.trust.teachers", "Female teachers only")}</span>
            </div>
            <div className="flex items-center gap-2">
              <Heart className="w-5 h-5 text-accent" />
              <span className="font-medium">{t("home.trust.age", "No age limit")}</span>
            </div>
            <div className="flex items-center gap-2">
              <Video className="w-5 h-5 text-accent" />
              <span className="font-medium">{t("home.trust.zoom", "Live on Zoom")}</span>
            </div>
            <div className="flex items-center gap-2">
              <Award className="w-5 h-5 text-accent" />
              <span className="font-medium">{t("home.trust.trial", "Free trial class")}</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container px-4 max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-10">
            ...
            <Button
              ...
              asChild
            >
              <Link href="/testimonials">{t("home.testimonials.view_all", "Read all stories →")}</Link>
            </Button>
          </div>
      ...
      <section className="py-20 bg-primary text-center px-4 relative overflow-hidden">
        <div className="container relative z-10 max-w-3xl mx-auto space-y-6">
          ...
          <p className="text-lg text-primary-foreground/85">
            {t("home.final_cta.subtitle", "Try a real class with our teacher. No payment, no commitment — see if it's right for you.")}
          </p>
