...
export default function SEOLandingPage({ slug }: SEOLandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-background pb-24 pt-4 sm:pt-8 overflow-x-hidden">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative bg-background overflow-hidden py-16 sm:py-24 lg:py-32 border-b border-primary/5 flex items-center min-h-[50dvh]">
        <div className="absolute inset-0 z-0 pointer-events-none w-full h-full">
          ...
          />
          {/* Subtle radial glow and arabesque overlay */}
      ...
      {/* 2. AI QUICK ANSWER BLOCK */}
      <section className="container px-4 max-w-4xl -mt-8 sm:-mt-12 relative z-20">
        <motion.div 
          variants={fadeIn}
          initial="hidden"
          whileInView="show"
      ...
      <section className="py-16 sm:py-24 border-y border-primary/5 bg-primary/[0.01]">
      ...
      <section className="bg-card border-t border-primary/5 py-12 sm:py-16">
      ...
      <section className="container px-4 mt-8 max-w-4xl">
