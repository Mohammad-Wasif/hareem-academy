...
export default function AdminMedia() {
  ...
  const combinedFiles = useMemo(() => {
    const standardSlots = [
      ...
      {
        key: "hero_bg",
        name: "hero-pattern-bg.webp",
        fallbackUrl: "/hero-bg.webp",
        folder: "hero",
      ...
      {
        key: "teacher_1",
        name: "ustadha-fatima-portrait.webp",
        fallbackUrl: "/teacher-1.webp",
        folder: "teachers",
      ...
      {
        key: "teacher_2",
        name: "ustadha-ayesha-portrait.webp",
        fallbackUrl: "/teacher-2.webp",
        folder: "teachers",
      ...
      {
        key: "teacher_3",
        name: "ustadha-zainab-portrait.webp",
        fallbackUrl: "/teacher-3.webp",
        folder: "teachers",
      ...
      {
        key: "course_arabic",
        name: "arabic-beginner-thumbnail.webp",
        fallbackUrl: "/course-arabic.webp",
        folder: "courses",
      ...
      },
      {
        ...
        name: "arabic-intermediate-thumbnail.webp",
        fallbackUrl: "/course-arabic.webp",
        folder: "courses",
      ...
      {
        key: "course_urdu",
        name: "urdu-beginner-thumbnail.webp",
        fallbackUrl: "/course-urdu.webp",
        folder: "courses",
